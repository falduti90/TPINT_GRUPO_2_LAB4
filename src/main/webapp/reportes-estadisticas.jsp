...
<div class="card shadow mb-4 mx-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Gráfico de Cuentas por Tipo</h6>
    </div>
    <div class="card-body">
...
<div class="card shadow mb-4 ">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Gráfico de Tipos de movimientos registrados</h6>
    </div>
    <div class="card-body">
...
<div class="card shadow mb-4 mx-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Saldo Promedio por Tipo de Cuenta</h6>
    </div>
    <div class="card-body">
...
<h2 style="margin:auto; margin-bottom:40px;text-align:center;margin-top:120px"><b>Prestamos Activos por cliente</b></h2>

<% 
Map<String, Integer> prestamosPorClienteMap = (Map<String, Integer>) request.getAttribute("prestamosPorCliente");
if(prestamosPorClienteMap != null && !prestamosPorClienteMap.isEmpty()) { %>
    <div class="container">
        <table id="miTabla2" class="table table-info table-striped table-hover mt-5 shadow-lg p-3 mb-5 bg-body-tertiary rounded">
            <thead>
                <tr>
...
<h2 style="margin:auto; margin-bottom:40px;text-align:center;margin-top:120px"><b>Clientes por localidad</b></h2>
...
<%
    Map<String, Integer> movimientosPorTipoMap = (Map<String, Integer>) request.getAttribute("movimientosXTipo");
...
<script>
    ...
    var ctxSaldo = document.getElementById('graficoSaldoPromedio').getContext('2d');
    ...
    var optionsSaldo = {
        ...
        scales: {
            x: {
                beginAtZero: true // Asegura que la escala comience en cero
            }
        }
    };
